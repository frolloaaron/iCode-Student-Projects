...
public partial class Pokemon_Cards : ContentPage
{
    ...
    async private void OpenPackButton_Clicked(object sender, EventArgs e)
    {
        ...
        App.UserRepo.UpdateUserPokemon_Cards(App.LoggedInUser, column1);
        App.UserRepo.UpdateUserPokemon_Cards(App.LoggedInUser, column2);
        App.UserRepo.UpdateUserPokemon_Cards(App.LoggedInUser, column3);
        App.UserRepo.UpdateUserPokemon_Cards(App.LoggedInUser, column4);
        ...
        await BottomPack.TranslateTo(0, TopPack.Y + 300, 2000, Easing.Linear);
